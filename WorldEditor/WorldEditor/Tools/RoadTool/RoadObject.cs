...
namespace WorldEditor.UI.Tools.RoadTool
{
    interface IRoadObject
    {
        ...
        ///// <param name="point">The point.</param>
        ///// <returns></returns>
        //bool RemovePoint(RoadPoint point);
        ///// <summary>
        ///// Removes the point by id.
        ///// </summary>
        ///// <param name="id">The id.</param>
        ///// <returns></returns>
        //bool RemovePointByName(string name);
        ///// <summary>
        ///// Finds the point by id.
        ///// </summary>
        ///// <param name="id">The id.</param>
        ///// <returns></returns>
        //int FindPointByName(string name);
        ///// <summary>
        ///// Gets the begin point.
        ///// </summary>
        ///// <returns></returns>
        //RoadPoint getBeginPoint();
        ///// <summary>
        ///// Gets the end point.
        ///// </summary>
        ///// <returns></returns>
        ...
        ///// </summary>
        ///// <returns></returns>
        //List<RoadPoint> getBorderPoints();
        ///// <summary>
        ///// Draws the road part
        ///// </summary>
